...
namespace UCM.IAV.AI.Search {
    ...
    public class Node : IEquatable<Node>, IComparable<Node>, IComparable { // Realmente no es imprescindible que sean comparables
        ...
        // Si Node fuese inmutable puedo cachear el código hash y la representación en forma de cadena para no recalcularlos cada vez
        ...
        public override bool Equals(object obj) {
            if (obj is Node) // Mejor que typeof que obligaría a ser del tipo exacto
