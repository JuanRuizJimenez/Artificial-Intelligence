...
namespace UCM.IAV.Puzzles.Model {
    ...
    public class SlidingPuzzle : IDeepCloneable<SlidingPuzzle>, IEquatable<SlidingPuzzle>, IComparable<SlidingPuzzle>, IComparable {
        ...
        // Si SlidingPuzzle fuese inmutable puedo cachear el código hash y la representación en forma de cadena para no recalcularlos cada vez
        ...
        public override bool Equals(object obj) {
            if (obj is SlidingPuzzle) // Mejor que typeof que obligaría a ser del tipo exacto
        ...
        public override string ToString() {
			return "Método comentado por fallos.";
